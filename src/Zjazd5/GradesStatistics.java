...
Summary: Class GradesStatistics to exercise 05.07
 */
package Zjazd5;
...
public class GradesStatistics {
    ...
    public double getAverage(int studentsNumber, List<Integer> studentsGrades) {
        int result = 0;
        for (Integer grades : studentsGrades) {
            result += grades;
        }
        return (double) result / studentsNumber;
    }
